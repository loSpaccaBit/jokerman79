...
// Variabile per mantenere il riferimento alla connessione WebSocket
let liveStatsConnection: WebSocket | null = null;
...
export default {
    ...
    async initialize(): Promise<void> {
        ...
        liveStatsConnection = ws;
    },

    async destroy(): Promise<void> {
        if (liveStatsConnection) {
            liveStatsConnection.close();
