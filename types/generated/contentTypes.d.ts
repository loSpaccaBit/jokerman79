...
export interface ApiAdvertisementAdvertisement
  ...
  info: {
    description: 'Advertisements and promotional content';
  ...
  attributes: {
    ...
    position: Schema.Attribute.Enumeration<
      ['header', 'sidebar', 'footer', 'content', 'mobile']
    > &
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Jokerman79'>;
...
export interface ApiLiveGameLiveGame extends Struct.CollectionTypeSchema {
  collectionName: 'live_games';
  info: {
    description: 'Configurazione dei giochi live disponibili';
  ...
  attributes: {
    assetMapping: Schema.Attribute.JSON;
    ...
    gameId: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    gameType: Schema.Attribute.Enumeration<
      [
        'ROULETTE',
        'DRAGONTIGER',
        'MEGAWHEEL',
    ...
    provider: Schema.Attribute.Enumeration<['pragmatic', 'evolution']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    resultAssets: Schema.Attribute.Media<'images', true>;
    sortOrder: Schema.Attribute.Integer;
    streamingUrl: Schema.Attribute.String;
    tableIds: Schema.Attribute.JSON & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Partners displayed on homepage';
    displayName: 'Partner';
    pluralName: 'partners';
...
export interface ApiProviderBonusProviderBonus
  extends Struct.CollectionTypeSchema {
  collectionName: 'provider_bonuses';
  info: {
    description: 'Exclusive bonuses for specific providers';
    displayName: 'Provider Bonus';
    pluralName: 'provider-bonuses';
    singularName: 'provider-bonus';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['welcome', 'deposit', 'free-spins', 'cashback', 'reload']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProviderProvider extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Game providers/developers';
  ...
  attributes: {
    bonuses: Schema.Attribute.Relation<
      'oneToMany',
      'api::provider-bonus.provider-bonus'
    >;
    ...
    isVisible: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    licenses: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    rating: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    reviewCons: Schema.Attribute.JSON;
    reviewPros: Schema.Attribute.JSON;
    reviewSummary: Schema.Attribute.Text;
    reviewVerdict: Schema.Attribute.RichText;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slots: Schema.Attribute.Relation<'oneToMany', 'api::slot.slot'>;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiRouteRoute extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Site routes and navigation';
    displayName: 'Route';
    pluralName: 'routes';
    singularName: 'route';
  };
  ...
  attributes: {
    component: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiSlotSlot extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Casino slot machines';
    displayName: 'Slot';
    pluralName: 'slots';
    singularName: 'slot';
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::slot.slot'> &
      Schema.Attribute.Private;
    maxBet: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
        number
      >;
    maxWin: Schema.Attribute.String;
    minBet: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    rating: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    realUrl: Schema.Attribute.String;
    ...
    reviewPros: Schema.Attribute.JSON;
    reviewSummary: Schema.Attribute.Text;
    reviewVerdict: Schema.Attribute.Text;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::provider-bonus.provider-bonus': ApiProviderBonusProviderBonus;
